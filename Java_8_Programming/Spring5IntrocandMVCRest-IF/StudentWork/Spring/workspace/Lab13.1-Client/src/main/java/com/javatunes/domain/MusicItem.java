 ...
 *
 */
@JacksonXmlRootElement(localName="item") // Jackson XML annotation
public class MusicItem {

	private Long id;
	private String title, artist;
	@JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd") // Jackson annotation to set date format in JSON/XML
